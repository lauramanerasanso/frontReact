...
.form-control:focus {
  ...
  border-color: #e6dff7;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(150, 122, 220, 0.25);
}
...
.btn-primary:focus, .btn-primary.focus {
  ...
  background-color: #7e5cd4;
  border-color: #7652d1;
  box-shadow: 0 0 0 0.2rem rgba(166, 142, 225, 0.5);
}
...
.custom-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(150, 122, 220, 0.25);
}
